...
const Sidebar = ({ user }) => {
  return (
    <aside className="sidebar">
      ...
      <div style={{ padding: '0 16px', margin: '16px 0 8px', color: 'var(--text-muted)', fontSize: '0.75rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
        🩺 Health Monitoring
      </div>
      <nav>
      ...
      <div style={{ padding: '0 16px', margin: '24px 0 8px', color: 'var(--text-muted)', fontSize: '0.75rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
